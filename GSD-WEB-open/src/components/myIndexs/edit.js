           ...
           // const blocksFromHTML = htmlToDraft(`<p>${nextProps.myIndexs.currentIndexData.note}</p>`);
            ...
            this.setState({
                        ...
                        indexData: nextProps.myIndexs.currentIndexData,
                         content:nextProps.myIndexs.currentIndexData.note_text
                    });
    ...
    handleDrop(e) {
        ...
        if (!!files && files.length > 0) {
            ...
            if(!!dataStr){
                ...
                var uploadUrl = data.fileurl;
                var filename = data.filename;
                if (type == '视频') {
                    var videoHtml = this.videoHTML(uploadUrl);
                    this.ueditor.ueditor.execCommand('inserthtml', videoHtml);
                } else if (type == '图片') {
    ...
    render() {
        ...
        return (
                        ...
                        <Paper className={classes.root} elevation={1}>
                            ...
                            id="Literature"/>} key="2">
                                    ...
                                    <div>
                                        <div style={{marginTop:"20px"}}>
                                            <Button disabled={this.props.myIndexs.pageInfos.isChanging}
                                                    onClick={()=>this.saveData(1)} style={{marginRight:"15px"}}
                                                    variant="contained"
                                                    color="primary" className={classes.okBtn}>
                                                {this.props.myIndexs.pageInfos.isChanging && <CircularProgress
                                                    className={classes.removeProgress}
                                                    size={18}
                                                />}<FormattedMessage id="Save Note and Reference"/>
                                            </Button>
            ...
            underline: classes.cssUnderline,
                                            ...
                                            {(this.state.indexData.message_type=='INF'||this.state.indexData.message_type == "JN") && <div className="col-sm-6">
                                                <FormControl className={classes.margin} fullWidth>
                                                    <InputLabel
                                                        FormLabelClasses={{
            root: classes.cssLabel,
