...
class FilterScatter extends Component {
   ...
   createRandomItemStyle() {
    ...
    render() {
        ...
        return (
            <div>
                <div><h4 style={{fontSize:"1.1rem",color:"rgb(135, 134, 134)"}}>{this.props.intl.formatMessage({id: 'Scatter Filter'})}
                    <Button
                ...
                <div className={this.state.toggleState?"toolDiv":"toolDiv visible"}>
                    <a href={"/toolPages/threedFilterChart?searchValue="+this.props.searchResult.searchTitle} target="_blank">
                    <img src="/sourceImages/scatter_pic.png" style={{width:"100%"}}/>
                        </a>
                      </div>
            </div>
