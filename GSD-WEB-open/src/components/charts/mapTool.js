...
class MapTools extends Component {
   ...
   createRandomItemStyle() {
    ...
    render() {
        ...
        return (
            <div>
                <div><h4 style={{fontSize:"1.1rem",color:"rgb(135, 134, 134)"}}>{this.props.intl.formatMessage({id: 'Data Visualization'})}
                    <Button
                ...
                <div className={this.state.toggleState?"toolDiv":"toolDiv visible"}>
                    <a href="/toolPages/gisMap" target="_blank">

                    <img src="/sourceImages/map_pic.png" style={{width:"100%"}}/>
                    </a>
                      </div>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(withStyles(styles)(MapTools)));
